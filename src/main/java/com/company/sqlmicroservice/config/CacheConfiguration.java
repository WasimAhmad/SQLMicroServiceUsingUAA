...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SQLMicroServiceUsingUAA");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SQLMicroServiceUsingUAA");
        ...
        config.getMapConfigs().put("com.company.sqlmicroservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
